  ...
  return (
    <div className="flex items-center flex-col md:flex-row gap-8 my-8">
      <picture className="flex-[0.3]">
        ...
        ></source>
        <img src="../../public/images/illustration-hero-mobile.png" alt="" className='w-full h-full'/>
      </picture>
      <div className="flex-[0.4] flex flex-col items-center gap-4 text-center p-4 bg-style relative self-end">
        <h1 className="text-4xl text-white">
          Get paid for the work you <span className="text-[#3EEAE7]">love </span> to do.
        </h1>
      ...
      <picture className="flex-[0.3]">
        ...
        ></source>
        <img src="../../public/images/illustration-hero-mobile.png" alt="" className='hidden md:block w-full h-full'/>
      </picture>
    </div>
  );
};
